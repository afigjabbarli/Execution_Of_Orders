...
public class ProductController : Controller
{
    ...
    public ProductController(PustokDbContext dbContext, IFileService fileService, IVerificationService verification)
    {
    ...
    public IActionResult Add(ProductAddViewModel model)
    {
        ...
        product.TrackingCode = _verification.GenerateProductCode();
